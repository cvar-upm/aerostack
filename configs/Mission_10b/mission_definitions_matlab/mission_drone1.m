...
% mission_text{end+1} = go_to_point_look_to_simp(1, 'D4' , 'C7', points_information, point_names, columns_information, column_names);
...
mission_text{end+1} = go_to_point_look_to_simp(4, 'D1F', 'C3', points_information, point_names, columns_information, column_names);
