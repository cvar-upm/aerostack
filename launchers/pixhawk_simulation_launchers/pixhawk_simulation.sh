...
roslaunch ${AEROSTACK_STACK}/launchers/pixhawk_simulation_launchers/launch_files/px4_SITL.launch  --wait drone_id_int:=$NUMID_DRONE drone_id_namespace:=drone$NUMID_DRONE my_stack_directory:=${AEROSTACK_STACK};
						exec bash\""  \
