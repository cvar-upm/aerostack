...
roslaunch ${AEROSTACK_STACK}/launchers/pixhawk_launchers/launch_files/driver_px4flow_interface_ROSModule_wo_altitude.launch --wait drone_id_int:=$NUMID_DRONE drone_id_namespace:=drone$NUMID_DRONE my_stack_directory:=${AEROSTACK_STACK};
						exec bash\""  \
...
roslaunch ${AEROSTACK_STACK}/launchers/pixhawk_launchers/launch_files/usb_cam.launch --wait drone_id_namespace:=drone$NUMID_DRONE drone_id_int:=$NUMID_DRONE my_stack_directory:=${AEROSTACK_STACK};
						exec bash\""  \
