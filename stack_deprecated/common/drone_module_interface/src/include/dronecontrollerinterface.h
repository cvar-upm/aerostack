#ifndef DRONECONTROLLERINTERFACE_H
#define DRONECONTROLLERINTERFACE_H
...
class DroneControllerInterface : public DroneModuleInterface
{
public:
    DroneControllerInterface(const std::string &module_name_str_in, const ModuleNames::name module_name_enum_in);
...
#endif // DRONECONTROLLERINTERFACE_H
