...
mission_text{end+1} = go_to_point_look_to_simp( 4, 'T8',      'C5' , points_information, point_names, columns_information, column_names);
...
mission_text{end+1} = go_to_point_look_to_simp( 7, 'D5F',     'C12', points_information, point_names, columns_information, column_names);
