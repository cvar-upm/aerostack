...
mission_text{end+1} = go_to_point_look_to_simp( 2, 'D2F', 'C4' , points_information, point_names, columns_information, column_names);
...
mission_text{end+1} = go_to_point_look_to_simp( 4, 'D5F', 'C10', points_information, point_names, columns_information, column_names);
