...
mission_text{end+1} = go_to_point_look_to_simp( 2,'JUST_LOOK','C2' , points_information, point_names, columns_information, column_names);
mission_text{end+1} = go_to_point_look_to_simp( 3, 'D5' ,     'C2' , points_information, point_names, columns_information, column_names);
...
mission_text{end+1} = go_to_point_look_to_simp( 7, 'D2F',     'C5' , points_information, point_names, columns_information, column_names);
